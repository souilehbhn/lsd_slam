...
class Frame {
 public:
  ...
  /** Prepares this frame for stereo comparisons with the other frame (computes
   * some intermediate values that will be needed) */
  void prepareForStereoWith(Frame* other, Sim3 thisToOther,
  ...
  std::unordered_multimap<
      Frame*, Sim3, std::hash<Frame*>, std::equal_to<Frame*>,
